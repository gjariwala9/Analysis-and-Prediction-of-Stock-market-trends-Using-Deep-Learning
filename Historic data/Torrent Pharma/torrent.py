...
dataset_train = pd.read_csv('torrent_train.csv')
...
dataset_test = pd.read_csv('torrent_test.csv')
...
'''
pd.DataFrame(predicted_stock_price).to_csv("predicted_values_torrent.csv")
regressor.save("torrent.h5")

'''from keras.models import load_model
regressor=load_model('torrent.h5')'''