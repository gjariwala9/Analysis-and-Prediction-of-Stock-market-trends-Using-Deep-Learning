...
pages = [19,13]  # numbers of pages per year in oder of years list
years = [2016,2015]
...
def fun():
    ...
    for (year,i) in zip(years,pages):
		...
		# Change this url according to the stock name
...
df.to_csv('news_mahindra_16_15.csv', index=False, encoding='utf-8')    
print('---------DONE-----------')
